...
INSERT INTO `configurations`
        VALUES (1, 'paypal_username', 'Paypal Username', '', 'string'), /* blank for commitment purposes */
                (2, 'paypal_password', 'Paypal Password', '', 'string'), /* blank for commitment purposes */
                (3, 'paypal_signature', 'Paypal Signature', '', 'string'), /* blank for commitment purposes */
                (4, 'paypal_version', 'Paypal Version', '86.0', 'string'),
                (5, 'paypal_test', 'Use Paypal Sandbox?', 'true', 'boolean'),
                (6, 'register_customerRequreMembershipFee', 'Require a membership fee for customer registration?', 'true', 'boolean'),
                (7, 'register_customerMembershipFee', 'Membership Fee', '', 'float');
